function t_sldsInit(t) {
    ...
    _ > 0 && (8 != (o = parseInt(n.substring(_ + 5, n.indexOf(".", _)))) && 9 != o || (c = !0)), 1 == c && l.removeClass("t-slds_animated-fast").removeClass("t-slds_animated-slow").addClass("t-slds_animated-none t-slds_ie").attr("data-slider-correct-height", "true"), window.$isMobile && 1 == l.hasClass("t-slds_animated-none") && l.removeClass("t-slds_animated-none").addClass("t-slds_animated-fast"), "true" == l.attr("data-slider-initialized") && (d -= 2), l.attr("data-slider-initialized", "true"), l.attr("data-slider-totalslides", d), l.attr("data-slider-pos", 1), l.attr("data-slider-cycle", ""), l.attr("data-slider-animated", "");
...
function t_slds_initSliderControls(t) {
    var s = $("#rec" + t), e = s.find(".t-slds__items-wrapper"), d = s.find(".t-slds__container").width();
    e.attr("data-slider-transition");
    if ("true" == e.attr("data-slider-stop")) return !1;
    e.css({transform: "translate3d(-" + d + "px, 0, 0)"}), s.find(".t-slds__arrow_wrapper").click(function () {
        var d = e.attr("data-slider-animated"), a = parseFloat(e.attr("data-slider-pos")),
            i = parseFloat(e.attr("data-slider-totalslides")), r = "";
        "" == d && (e.attr("data-slider-animated", "yes"), "left" === $(this).attr("data-slide-direction") ? "false" == e.attr("data-slider-with-cycle") && 1 == a ? a = 1 : a-- : "false" == e.attr("data-slider-with-cycle") && a == i ? a = i : a++, e.attr("data-slider-pos", a), a != i + 1 && 0 != a || (r = "yes"), e.attr("data-slider-cycle", r), t_slideMove(t));
        s.trigger("updateSlider")
    }), s.find(".t-slds__bullet").click(function () {
        var d = parseFloat($(this).attr("data-slide-bullet-for"));
        e.attr("data-slider-pos", d), t_slideMove(t), s.trigger("updateSlider")
    })
}
...
function t_slds_initAutoPlay(t, s, e) {
    var d = $("#rec" + t), a = d.find(".t-slds"), i = d.find(".t-slds__items-wrapper"),
        r = parseFloat(i.attr("data-slider-timeout")), l = "";
    if (stopSlider = i.attr("data-slider-stop"), "true" == stopSlider) return !1;
    a.hover(function (t) {
        i.attr("data-slider-hovered", "yes")
    }, function (t) {
        i.attr("data-slider-hovered", "")
    }), setInterval(function () {
        var a = $(window).scrollTop(), r = $(window).height(), n = d.offset().top, _ = d.innerHeight(),
            o = i.attr("data-slider-hovered"), c = i.attr("data-slider-autoplay-ignore-hover");
        a + r / 2 > n && n + _ > a && "yes" != o && "yes" != c && ("false" == i.attr("data-slider-with-cycle") && s == e ? s = e : s++, i.attr("data-slider-pos", s), s != e + 1 && 0 != s || (l = "yes"), t_slideMove(t), "yes" == l && (s == e + 1 && (s = 1), 0 == s && (s = e), i.attr("data-slider-pos", s)), i.attr("data-slider-cycle", l))
    }, r)
}
...
function t_slds_initSliderSwipe(t, s) {
    var e, d = $("#rec" + t), a = !1;
    if ("true" == d.find(".t-slds__items-wrapper").attr("data-slider-stop")) return !1;
